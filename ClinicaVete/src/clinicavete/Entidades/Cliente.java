...
public class Cliente {
    ...
    public String toString() {
        return "Cliente{" + "idCliente=" + idCliente + ", dni=" + dni + ", apellido=" + apellido + ", nombre=" + nombre + ", direccion=" + direccion + ", telefono=" + telefono + ", contactoNombre=" + contactoNombre + ", contactoTelefono=" + contactoTelefono + ", estado=" + estado + ", email=" + email + '}';
    }
